...
export const Footer = () => {
    return (
        <footer className="bg-white w-full border-t-2 border-gray-400">
            <div className="mx-auto md:w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        ...
                        >
                            <PottedPlant className="text-primary-600 hover:fill-primary-500" weight="duotone" size="3rem"/>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <Link
                            ...
                            className="text-gray-500 hover:text-primary-400 ms-5"
                        >
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
